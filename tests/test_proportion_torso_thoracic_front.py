...
def test_t10_waist_hip_bias_and_mid_back_z() -> None:
    """T10: 0074 waist/hip bias stay 0.42/0.22; mid_back z ≈ waist z."""
    assert TORSO_WAIST_Y_REAR_BIAS_FRAC_RY == 0.42
    assert TORSO_HIP_Y_REAR_BIAS_FRAC_RY == 0.22
...
def test_t14_product_like_hip_may_be_deeper_than_chest() -> None:
    """T14: product-like halves allow ry_c < ry_h; still chest>waist and hip>pelvis."""
